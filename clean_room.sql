INSERT INTO public.TMP_AO(
    ...
    guid, parentguid, regioncode, postalcode, null,     null, flatnumber,  flattype,     null, roomnumber,  roomtype, cadnum, null, livestatus,       null, operstatus,       0, startdate, updatedate, enddate FROM  public.TMP_ROOM WHERE  nextid is null;
