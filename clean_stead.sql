INSERT INTO public.TMP_AO(
    ...
    guid, parentguid, regioncode, postalcode, name, kod_t_st,     null,      null,     null,     null,      null, cadnum, null, livestatus, null, operstatus, divtype, startdate, updatedate, enddate FROM  public.stead WHERE  nextid is null;;
